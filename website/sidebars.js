	...
	docs: [
			...
			'Getting Started': [
				{
					Prerequisites: [
						...
						{
							Resources: [
								'getting-started/chaoscenter',
								'getting-started/chaosagents'
							]
						}
					]
				},
		...
		// Litmusctl
		{
			Litmusctl: [
				...
				{
					'Connect Agent': [
						'litmusctl/cluster-scope-installation',
						'litmusctl/namespace-scope-installation'
					]
				}
			],
		},
