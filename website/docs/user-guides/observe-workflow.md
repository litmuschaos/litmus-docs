...
Once the experiment completes, the [Chaos Results](../concepts/chaos-result) are also available alongside the logs. The Chaos Results are directly fetched from the ChaosResult CRD.
