...
Before setting up endpoint without Ingress, make sure [ChaosCenter](../getting-started/resources.md#chaoscenter) is installed. See the [Installation Guide](../getting-started/installation.md) for both HTTP and HTTPS installation options.
