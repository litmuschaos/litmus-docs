...
Follow this [guide](https://github.com/litmuschaos/litmusctl/blob/main/Usage_0.23.0.md#steps-to-connect-a-chaos-infrastucture) to connect a Chaos Infrastructure.
