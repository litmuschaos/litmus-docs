...
```bash
curl https://raw.githubusercontent.com/litmuschaos/litmus/master/mkdocs/docs/2.6.0/litmus-namespaced-2.6.0.yaml --output litmus-portal-namespaced-K8s-template.yml
