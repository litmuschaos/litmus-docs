...
To upgrade Litmus ChaosCenter from 2.9.0 to 2.10.0, you can follow these steps:
...
1. Upgrade the control plane (ChaosCenter)
   ...
   ```bash
   kubectl apply -f https://raw.githubusercontent.com/litmuschaos/litmus/master/mkdocs/docs/2.10.0/litmus-2.10.0.yaml
   ```
