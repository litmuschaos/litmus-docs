...
```bash
kubectl delete -f https://raw.githubusercontent.com/litmuschaos/litmus/main/litmus-portal/manifests/litmus-portal-crds.yml
```
...
- **Litmus 3.6.0**
  ...
  ```bash
  kubectl delete -f https://litmuschaos.github.io/litmus/3.6.0/litmus-cluster-scope-3.6.0.yaml
  ```
...
- **Litmus Master Manifest**
  ...
  ```bash
  kubectl delete -f https://raw.githubusercontent.com/litmuschaos/litmus/main/litmus-portal/manifests/cluster-k8s-manifest.yml
  ```
