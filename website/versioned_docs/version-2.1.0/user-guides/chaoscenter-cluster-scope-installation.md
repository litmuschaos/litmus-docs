...
> If you are installing Litmus in any other namespace apart from `litmus` namespace, make sure to change the same in the manifest too `https://raw.githubusercontent.com/litmuschaos/litmus/master/mkdocs/docs/2.1.0/litmus-2.1.0.yaml`.
