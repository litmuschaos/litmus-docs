...
```bash
kubectl apply -f https://litmuschaos.github.io/litmus/3.2.0/litmus-cluster-scope-3.2.0.yaml
```

> If you are installing Litmus in any other namespace apart from `litmus` namespace, make sure to change the same in the manifest too `https://litmuschaos.github.io/litmus/3.2.0/litmus-namespaced-3.2.0.yaml`.
