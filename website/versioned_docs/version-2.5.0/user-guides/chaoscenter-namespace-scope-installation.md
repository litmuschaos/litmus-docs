...
```bash
curl https://raw.githubusercontent.com/litmuschaos/litmus/master/mkdocs/docs/2.5.0/litmus-namespaced-2.5.0.yaml --output litmus-portal-namespaced-K8s-template.yml
envsubst '${LITMUS_PORTAL_NAMESPACE}' < litmus-portal-namespaced-K8s-template.yml >
