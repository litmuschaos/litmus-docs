...
To upgrade Litmus ChaosCenter from 2.4.0 to 2.5.0, you can follow these steps:
...
1. Upgrade the control plane (ChaosCenter)
   ...
   ```bash
   kubectl apply -f https://raw.githubusercontent.com/litmuschaos/litmus/master/mkdocs/docs/2.5.0/litmus-namespaced-2.5.0.yaml
   ```
