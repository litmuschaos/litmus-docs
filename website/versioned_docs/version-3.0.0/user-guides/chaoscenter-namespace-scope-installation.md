...
```bash
kubectl apply -f https://raw.githubusercontent.com/litmuschaos/litmus/main/chaoscenter/manifests/litmus-portal-crds.yml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/litmuschaos/litmus/main/mkdocs/docs/3.0.0-beta6/litmus-namespaced-3.0.0-beta6.yaml -n <Your Namespace>
```
