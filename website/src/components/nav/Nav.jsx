...
const Ul = styled.ul`
	...
	li {
		padding: ${(props) =>
			props.theme.screens.mmd ? '1rem 0.3rem' : props.theme.screens.xl ? '0.7rem 0.5rem' : '1rem 0.65rem'};
		font-size: ${(props) => (props.theme.screens.mmd ? '0.9rem' : props.theme.fontSize.button)};
	}
`
...
const NavLinks = () => (
	<LogoDiv>
		<Link to="/">
			<Center>
				<img src="../../../static/img/logo-with-text.svg" width="84" height="32" alt="litmus logo" />
			</Center>
		</Link>

		<a rel="noopener noreferrer" target="_blank" href="https://github.com/litmuschaos/litmus">
			<Center>
				<GitHubStars>
					{/* <GithubIcon /> */}
	...
	return md ? (
		...
		<NavBar>
			...
			<Ul>
				...
				<li>
					<a rel="noopener noreferrer" target="_blank" href="https://dev.to/t/litmuschaos">
						Blogs
					</a>
				</li>
